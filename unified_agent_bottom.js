...
async function extractAllInOneVisit(url, browser, needsMetadata, needsVideoId, existingStoreLink, attempt = 1) {
    ...
    try {
        ...
        // REMOVED APPLE STORE SKIP - Process every ad now
        ...
        // Extract video ID for ALL video ads (including Apple Store if needed)
        if ((isVideoAd || needsVideoId) && (needsVideoId || needsMetadata)) {
